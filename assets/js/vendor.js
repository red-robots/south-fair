...
$.fn.inView = function (t) {
  ...
  switch (p.top = this.offset().top + o, p.bottom = p.top + this.outerHeight(), t) {
    case "bottomOnly":
...
(function (e, t, n) {
  ...
  t.infinitescroll.prototype = {
    ...
    _determinepath: function _determinepath(t) {
      var r = this.options;
    ...
    _loadcallback: function _loadcallback(i, s, o) {
      var u = this.options,
